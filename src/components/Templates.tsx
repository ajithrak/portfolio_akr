...
export const Templates: React.FC = () => {
  return (
    <section id="templates" className="py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-16">
      <motion.div
      ...
      >
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white mb-3 border-b pb-2 border-gray-100 dark:border-zinc-800">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {TEMPLATES_DATA.map((template) => (
            <Link
              key={template.slug}
              to={template.href}
              className="group flex flex-col h-full bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl overflow-hidden hover:shadow-md transition-shadow p-6"
            >
              <span
